...
#ifndef RTW_HEADER_ARDroneHoverSim_acc_private_h_
#define RTW_HEADER_ARDroneHoverSim_acc_private_h_
#include "rtwtypes.h"
...
ARDroneHoverSim_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart
