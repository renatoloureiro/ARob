...
MODEL                  = ARDroneHoverSim
MODULES                = rt_logging.c ARDroneHoverSim_capi.c ARDroneHoverSim_data.c ARDroneHoverSim_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c
MAKEFILE               = ARDroneHoverSim.mk
MATLAB_ROOT            = /Applications/MATLAB_R2017b.app
ALT_MATLAB_ROOT        = /Applications/MATLAB_R2017b.app
MATLAB_ROOTQ           = \"/Applications/MATLAB_R2017b.app\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /Users/PauloOliveira\ 1/Desktop/AR_Lab/DevKit/ARDroneSimulinkDevKit_V1.1/simulation
...
COMPUTER               = MACI64
BUILDARGS              =  ISPROTECTINGMODEL=NOTPROTECTING RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/Applications/MATLAB_R2017b.app" EXT_MODE=1 OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	...
	-I../../../slprj/raccel/ARDroneHoverSim \
