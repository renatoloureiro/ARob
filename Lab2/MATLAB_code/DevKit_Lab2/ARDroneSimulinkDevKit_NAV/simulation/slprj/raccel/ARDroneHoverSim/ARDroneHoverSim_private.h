...
#ifndef RTW_HEADER_ARDroneHoverSim_private_h_
#define RTW_HEADER_ARDroneHoverSim_private_h_
#include "rtwtypes.h"
...
#error Model (ARDroneHoverSim) was built \in MultiTasking solver mode, however the MULTITASKING define \is not present. Please verify that your template makefile is \configured correctly.
#endif
#endif
