...
MODEL                := ARDroneWPTracking_V2
MODULES              := ARDroneWPTracking_V2_data.c ARDroneWPTracking_V2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ARDroneWPTracking_V2.mk
...
SLDRTDIR             := /Applications/MATLAB_R2017b.app/toolbox/sldrt
TARGETARCH           := maci64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := ARDroneWPTracking_V2lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ARDroneWPTracking_V2_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;..;$(MATLAB_ROOT)/simulink/include/sf_runtime;../ARDroneWPTracking_V2_sldrt_maci64;/Users/PauloOliveira\ 1/Desktop/AR_Lab/AUXS/DevKit/ARDroneSimulinkDevKit_V1.1/wifiControl;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
