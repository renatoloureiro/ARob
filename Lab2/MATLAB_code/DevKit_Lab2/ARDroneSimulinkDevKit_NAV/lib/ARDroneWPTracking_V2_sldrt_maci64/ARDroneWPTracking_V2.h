...
#ifndef RTW_HEADER_ARDroneWPTracking_V2_h_
#define RTW_HEADER_ARDroneWPTracking_V2_h_
#include <math.h>
#include <string.h>
#ifndef ARDroneWPTracking_V2_COMMON_INCLUDES_
# define ARDroneWPTracking_V2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* ARDroneWPTracking_V2_COMMON_INCLUDES_ */

#include "ARDroneWPTracking_V2_types.h"
...
#define ARDroneWPTracking_V2_rtModel   RT_MODEL_ARDroneWPTracking_V2_T
...
typedef struct {
  ...
  real_T XeRef;                        /* '<S3>/Waypoint manager ' */
  real_T YeRef;                        /* '<S3>/Waypoint manager ' */
  ...
  uint8_T RateTransition[2];           /* '<S11>/Rate Transition' */
...
} DW_ARDroneWPTracking_V2_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator_CSTATE[2];         /* '<S19>/Integrator' */
} X_ARDroneWPTracking_V2_T;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator_CSTATE[2];         /* '<S19>/Integrator' */
} XDot_ARDroneWPTracking_V2_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE[2];      /* '<S19>/Integrator' */
} XDis_ARDroneWPTracking_V2_T;
...
#define rtB                            ARDroneWPTracking_V2_B
#define BlockIO                        B_ARDroneWPTracking_V2_T
#define rtX                            ARDroneWPTracking_V2_X
#define ContinuousStates               X_ARDroneWPTracking_V2_T
#define rtXdot                         ARDroneWPTracking_V2_XDot
#define StateDerivatives               XDot_ARDroneWPTracking_V2_T
#define tXdis                          ARDroneWPTracking_V2_XDis
#define StateDisabled                  XDis_ARDroneWPTracking_V2_T
#define rtP                            ARDroneWPTracking_V2_P
#define Parameters                     P_ARDroneWPTracking_V2_T
#define rtDWork                        ARDroneWPTracking_V2_DW
#define D_Work                         DW_ARDroneWPTracking_V2_T

/* Parameters (auto storage) */
struct P_ARDroneWPTracking_V2_T_ {
...
struct tag_RTM_ARDroneWPTracking_V2_T {
  const char_T *path;
...
extern P_ARDroneWPTracking_V2_T ARDroneWPTracking_V2_P;

/* Block signals (auto storage) */
extern B_ARDroneWPTracking_V2_T ARDroneWPTracking_V2_B;

/* Continuous states (auto storage) */
extern X_ARDroneWPTracking_V2_T ARDroneWPTracking_V2_X;

/* Block states (auto storage) */
extern DW_ARDroneWPTracking_V2_T ARDroneWPTracking_V2_DW;
...
extern void ARDroneWPTracking_V2_initialize(void);
extern void ARDroneWPTracking_V2_output0(void);
extern void ARDroneWPTracking_V2_update0(void);
extern void ARDroneWPTracking_V2_output(int_T tid);
extern void ARDroneWPTracking_V2_update(int_T tid);
extern void ARDroneWPTracking_V2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ARDroneWPTracking_V2_rtModel *ARDroneWPTracking_V2(void);
...
extern RT_MODEL_ARDroneWPTracking_V2_T *const ARDroneWPTracking_V2_M;
 ...
 *
 * '<Root>' : 'ARDroneWPTracking_V2'
 * '<S1>'   : 'ARDroneWPTracking_V2/ARDrone Wi-Fi  Block'
 * '<S2>'   : 'ARDroneWPTracking_V2/Baseline Controller1'
 * '<S3>'   : 'ARDroneWPTracking_V2/Guidance logic'
 * '<S4>'   : 'ARDroneWPTracking_V2/Position estimation Important:This block provides an  inaccurate extimation of position  based on  velocity information. '
 * '<S5>'   : 'ARDroneWPTracking_V2/Visualization of Drone states'
 * '<S6>'   : 'ARDroneWPTracking_V2/ARDrone Wi-Fi  Block/ARDrone data decoding'
 * '<S7>'   : 'ARDroneWPTracking_V2/ARDrone Wi-Fi  Block/Data synchronization '
 * '<S8>'   : 'ARDroneWPTracking_V2/ARDrone Wi-Fi  Block/Subsystem1'
 * '<S9>'   : 'ARDroneWPTracking_V2/ARDrone Wi-Fi  Block/This block sets the heading angle to zero when the  commands from the Simulink controller are enabled. '
 * '<S10>'  : 'ARDroneWPTracking_V2/ARDrone Wi-Fi  Block/Subsystem1/Drone state request'
 * '<S11>'  : 'ARDroneWPTracking_V2/ARDrone Wi-Fi  Block/Subsystem1/send byte to  state udp port  '
 * '<S12>'  : 'ARDroneWPTracking_V2/Baseline Controller1/Forward velocity controller '
 * '<S13>'  : 'ARDroneWPTracking_V2/Baseline Controller1/Heading controller'
 * '<S14>'  : 'ARDroneWPTracking_V2/Baseline Controller1/Height controller '
 * '<S15>'  : 'ARDroneWPTracking_V2/Baseline Controller1/Lateral velocity controller'
 * '<S16>'  : 'ARDroneWPTracking_V2/Baseline Controller1/Position controller'
 * '<S17>'  : 'ARDroneWPTracking_V2/Baseline Controller1/Position controller/Coordinate trnasformation  from inertial frame to body frame '
 * '<S18>'  : 'ARDroneWPTracking_V2/Guidance logic/Waypoint manager '
 * '<S19>'  : 'ARDroneWPTracking_V2/Position estimation Important:This block provides an  inaccurate extimation of position  based on  velocity information. /Position estimation'
 * '<S20>'  : 'ARDroneWPTracking_V2/Position estimation Important:This block provides an  inaccurate extimation of position  based on  velocity information. /Position estimation/Velocity from vehicle body frame  to inertial NED  frame'
 */
#endif                                 /* RTW_HEADER_ARDroneWPTracking_V2_h_ */
