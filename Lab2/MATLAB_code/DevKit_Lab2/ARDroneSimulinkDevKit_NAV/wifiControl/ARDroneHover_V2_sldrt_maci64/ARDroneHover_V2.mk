...
MODEL                := ARDroneHover_V2
MODULES              := ARDroneHover_V2_data.c ARDroneHover_V2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ARDroneHover_V2.mk
...
#
MODELLIB                  := ARDroneHover_V2lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ARDroneHover_V2_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;..;$(MATLAB_ROOT)/simulink/include/sf_runtime;../ARDroneHover_V2_sldrt_maci64;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
